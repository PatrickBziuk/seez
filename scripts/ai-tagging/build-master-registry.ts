...
function categorizeTagsIntoRegistry(
  ...
  const categoryKeywords = {
    technology: {
      en: ['programming', 'software', 'javascript', 'typescript', 'astro', 'ai', 'web', 'development', 'components', 'tech', 'code', 'api', 'database', 'framework', 'portique', 'foss', 'jamstack', 'supabase', 'deployment', 'accessibility', 'mdx', 'ui'],
      de: ['programmierung', 'software', 'javascript', 'typescript', 'astro', 'ki', 'web', 'entwicklung', 'komponenten', 'tech', 'code', 'api', 'datenbank', 'framework']
    },
    content: {
  ...
  for (const tag of tags) {
    ...
    for (const [categoryName, keywords] of Object.entries(categoryKeywords)) {
      ...
      if (categoryKeywordList.some(keyword => 
