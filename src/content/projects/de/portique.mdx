...
language: de
description: 'Eine europäische Open-Source Jamstack-Plattform mit Fokus auf digitale Souveränität, EU-Hosting und moderne Web-Entwicklung mit Astro und Supabase.'
authors:
  - authors/seez-de
tags:
  - Portique
...
translationHistory:
  - language: de
    ...
    timestamp: '2025-08-07T13:07:55.781Z'
...
ai_tldr: >-
  ...
  selbst gehostet werden können. Es bietet eine transparente, FOSS-basierte
...
4. **Progressives Onboarding:** Beginnen Sie mit statischem Hosting; erweitern Sie sich um visuelle Editoren, Supabase-unterstützte Backends und KI-Support-Assistenten.
...
- **Caddy**: Ursprungsserver mit Auto-HTTPS, Reverse-Proxy.
