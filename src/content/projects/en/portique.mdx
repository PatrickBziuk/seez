...
status:
  authoring: Human
ai_tldr: "Portique is an open, European alternative to proprietary Jamstack hosts (e.g. Netlify, Vercel): **Either managed by a European operator** (Deployment-as-a-Service) **Or self-hosted** using exactly the same FOSS-based stack (Astro, Gitea, Woodpecker, Caddy, Bunny.net; optionally Supabase) Goal: **Performance, GDPR-compliant data ownership, and usability** for SMEs/NGOs/freelancers without lock-in."
---
