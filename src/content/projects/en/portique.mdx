...
authors:
  - seez
ai_tldr: >-
  Portique is an open, European alternative to proprietary Jamstack hosts (e.g.
  Netlify, Vercel): **Either managed by a European operator**
  (Deployment-as-a-Service) **Or self-hosted** using exactly the same FOSS-based
  stack (Astro, Gitea, Woodpecker, Caddy, Bunny.net; optionally Supabase) Goal:
  **Performance, GDPR-compliant data ownership, and usability** for
  SMEs/NGOs/freelancers without lock-in.
ai_metadata:
  tokenUsage:
    tldr:
      tokens: 89
...
sources:
  - title: 'Jamstack.org - What is Jamstack?'
    url: 'https://jamstack.org/'
    type: 'documentation'
    description: 'Official Jamstack documentation and community resource'
  - title: 'Astro Documentation'
    url: 'https://docs.astro.build/'
    type: 'documentation'
    description: 'Official Astro framework documentation'
  - title: 'GDPR and Cloud Act Analysis'
    url: 'https://www.privacy-regulation.eu/'
    type: 'other'
    author: 'EU Privacy Regulation'
    description: 'European data protection and cloud sovereignty guidelines'
---
...
3. **Dual Operation Modes:**
   - _Managed_: A European provider handles build, deployment, updates, and monitoring.
