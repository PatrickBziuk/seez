...
firstPublishedAt: '2025-08-27T21:00:00Z'
image: '/images/figures/shift_work.png'
additionalImages:
  - '/images/figures/shift_afterwork.png'
  - '/images/figures/shift_comic.png'
notranslate: ['SZ-004', 'Shift']
alias: 'Der Arbeiter'
designation: 'SZ-004'
colorCode: '#374151'
symbolism:
  ...
  - icon: '🚬'
    meaning: 'Zigaretten — fünf Minuten Leben in Rauch kondensiert'
  - icon: '⚡'
    meaning: 'Energy Drinks — künstliche Wachheit um die Schicht zu überleben'
voiceCharacteristics:
  preset: 'Bodenständig, resigniert, unterdrückte Wut'
  style: ['Working Class Rap', 'Industrial Hip-Hop', 'Social Commentary', 'Blues Rap']
movementGrammar: ['stempeln', 'durchhalten', 'aufbegehren']
containmentNote: 'Shift repräsentiert die working class experience und Klassenschranken. Seine Themen können starke sozioökonomische Emotionen auslösen. Behandlung erfordert Sensibilität für Klassenunterschiede und wirtschaftliche Prekarität.'
tags: ['figure', 'character', 'music', 'working-class', 'social-commentary', 'labor']
---
