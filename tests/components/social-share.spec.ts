...
test.describe('Social Share Buttons', () => {
  ...
  test('should have LinkedIn share functionality', async ({ page }) => {
    ...
    if ((await contentLinks.count()) > 0) {
      ...
      const linkedinShare = page.locator('.share-linkedin, [href*="linkedin.com"], [data-share="linkedin"]');
  ...
  test('should have email share functionality', async ({ page }) => {
    ...
    if ((await contentLinks.count()) > 0) {
      ...
      const emailShare = page.locator('.share-email, [href^="mailto:"], [data-share="email"]');
...
test.describe('Copy to Clipboard Functionality', () => {
  test('should have copy-to-clipboard button', async ({ page }) => {
    ...
    if ((await contentLinks.count()) > 0) {
      ...
      const copyButton = page.locator('.copy-link, .copy-url, [data-copy], .share-copy, .clipboard-copy');
  ...
  test('should copy current page URL to clipboard', async ({ page }) => {
    ...
    if ((await contentLinks.count()) > 0) {
      ...
      const copyButton = page.locator('.copy-link, .copy-url, [data-copy], .share-copy');
  ...
  test('should show copy confirmation feedback', async ({ page }) => {
    ...
    if ((await contentLinks.count()) > 0) {
      ...
      if ((await copyButton.count()) > 0) {
        ...
        const feedback = page.locator('.copied, .copy-success, .tooltip, [data-copied="true"]');
        ...
        if ((await feedback.count()) > 0) {
          ...
          const hasFeedbackText = feedbackTexts.some((text) => buttonText?.toLowerCase().includes(text));
...
test.describe('Share Button Visual Design', () => {
  test('should have proper social media icons', async ({ page }) => {
    ...
    if ((await contentLinks.count()) > 0) {
      ...
      const shareButtons = page.locator('.share-button, .social-share, .share-twitter, .share-linkedin');
  ...
  test('should be responsive on mobile devices', async ({ page }) => {
    ...
    if ((await contentLinks.count()) > 0) {
      ...
      const shareSection = page.locator('.share-buttons, .social-share, .share-section');
